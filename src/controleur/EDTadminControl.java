...
public class EDTadminControl {
    ...
    public static void remplissageEDT1(Utilisateur util, Connection conne, EDTadmin edtmain) throws ParseException, SQLException {
        System.out.println("nous avons repurer les données suivante:"+util.getEmail()+";"+util.getNom());
        int id_util = util.getId();
        System.out.println("#######"+id_util);
        Etudiant etud = EtudiantDAO.find( id_util,conne);
      ...
      public static void rangement(Seance seance,EDTadmin edtmain,Cours cours) throws ParseException{
      ...
      public static void rangement(Connection conne, Seance seance,EDTadmin edtmain,Cours cours,Utilisateur prof,Groupe grp ) throws ParseException{
      ...
      /*
      public static void remplissagetext(Button jButton1A, Connection conne, Seance seance,EDTadmin edtmain,Cours cours,Utilisateur prof,Groupe grp ){
    ...
    /*
    public boolean remplissageEDTadmin(){
